  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-white border-b border-gray-100 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/50 via-transparent to-rose-50/50"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div className="text-center space-y-4">
            ...
            <div className="flex items-center justify-center space-x-3 pt-4">
              ...
              <div className="h-px w-16 bg-gradient-to-r from-rose-400 to-transparent"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          >
            {filteredProducts.map((product) => (
              <Card key={product.id} products={product} onQuickView={() => { }} />
            ))}
          </div>
        ) : (
